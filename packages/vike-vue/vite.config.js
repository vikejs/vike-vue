  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        ['hooks/Config/Config-client']: resolve(__dirname, './src/hooks/Config/Config-client.ts'),
        ['hooks/Config/Config-server']: resolve(__dirname, './src/hooks/Config/useConfig-server.ts'),
        ['hooks/Head/Head-client']: resolve(__dirname, './src/hooks/Head/Head-client.ts'),
        ['hooks/Head/Head-server']: resolve(__dirname, './src/hooks/Head/Head-server.ts'),
      },
      formats: ['es'],
    },
    rollupOptions: {
